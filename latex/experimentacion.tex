...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		...
		\end{axis}
	\end{tikzpicture}
	\caption{ECM para el video \textbf{Amanecer} con distintos métodos de Interpolación.}
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		...
		\end{axis}
	\end{tikzpicture}
	\caption{ECM para el video \textbf{Skate} con distintos métodos de Interpolación.}
	\label{fig:ecm_skate}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		...
		\end{axis}
	\end{tikzpicture}
	\caption{ECM para el video \textbf{Messi} con distintos métodos de Interpolación.}
	\label{fig:ecm_messi}
\end{figure}
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		...
		\end{axis}
	\end{tikzpicture}
	\caption{PSNR para el video \textbf{Amanecer} con distintos métodos de Interpolación.}
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		...
		\end{axis}
	\end{tikzpicture}
	\caption{PSNR para el video \textbf{Skate} con distintos métodos de Interpolación.}
...
\begin{figure}[H]
	...
	\begin{tikzpicture}
		...
		\end{axis}
	\end{tikzpicture}
	\caption{PSNR para el video \textbf{Messi} con distintos métodos de Interpolación.}
