...
podemos inferir una complejidad temporal para los metodos vecinos, interpolacion fragmentaria lineal e interpolacion por splines.
...
Todos los metodos enumerados previamente tienen la misma complejidad temporal que es
