...
al análisis, ya que se condice con lo analizado previamente utilizando el \texttt{ECM}.
...
\begin{itemize}
    \item El comportamiento general de los métodos para cada video no varió con respecto
        al escenario en el cual agregábamos 1 cuadro. Los análisis de movimiento brusco y
        cambios de cámaras se reafirman.
    \item En lineas generales, y en todos los videos, el error se incrementó con respecto al
        escenario en el cual agregábamos 1 cuadro, a excepción del método de Interpolación
