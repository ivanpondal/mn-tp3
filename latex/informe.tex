...
\begin{abstract}
   Hecho: los videos de bebes son graciosos. Y son mucho más graciosos cuando se miran en
   \textit{slow motion}.

   En este trabajo, nos centraremos en 4 diferentes métodos de Interpolación para generar
   automáticamente videos en cámara lenta. Esto se logra interpolando una cierta
