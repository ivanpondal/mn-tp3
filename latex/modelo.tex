...
El mismo se puede representar como $Ax = b$ que resulta en la siguiente matriz:

\setlength{\arraycolsep}{3pt}
\kbordermatrix{
	&c_0	&c_1	&c_2	&\dots	&c_{j-1}	&c_j	&c_{j+1}	&\dots	&c_{n-2}	&c_{n-1}	&c_n	&		&b \\
	&1		&0		&0		&\dots	&0			&0		&0			&\dots	&0			&0			&0		&\vrule	&0	\\
	&h_0	&2(h_0+h_1) &h_1	&\dots	&0		&0		&0			&\dots	&0			&0			&0		&\vrule	&\frac{3(a_2 - a_1)}{h_1} + \frac{3(a_0 - a_1)}{h_0} \\
	&\vdots	&\vdots	&\vdots	&\vdots	&\vdots		&\vdots	&\vdots		&\vdots	&\vdots		&\vdots		&\vdots &\vrule	&\vdots \\
	&0		&0		&0		&\dots	&h_{j-1} &2(h_{j-1}+h_j) &h_j	&\dots	&0			&0			&0		&\vrule	&\frac{3(a_{j+1} - a_j)}{h_j} + \frac{3(a_{j-1} - a_j)}{h_{j-1}} \\
	&\vdots	&\vdots	&\vdots	&\vdots	&\vdots		&\vdots	&\vdots		&\vdots	&\vdots		&\vdots		&\vdots	&\vrule	&\vdots \\
	&0		&0		&0		&\dots	&0			&0		&0			&\dots	&h_{n-2}	&2(h_{n-2}+h_{n-1}) &h_{n-1} &\vrule &\frac{3(a_n - a_{n-1})}{h_{n-1}} + \frac{3(a_{n-2} - a_{n-1})}{h_{n-2}} \\
	&0		&0		&0		&\dots	&0			&0		&0			&\dots	&0			&0			&1		&\vrule	&0
}
